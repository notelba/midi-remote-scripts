...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\AIRA_MX_1\NotifyingSessionComponent.py
...
class NotifyingSessionComponent(SessionComponent):
    ...
    def _enable_skinning(self):
        ...
        for scene_index in xrange(self._num_scenes):
            ...
            scene.set_playing_value(b'Session.ScenePlaying')
    ...
    def _on_offset_changed(self):
        if self._last_scene_offset != self._scene_offset:
            ...
            self._show_msg_callback(b'Controlling Scene %s' % name)
            self._last_scene_offset = self._scene_offset
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/AIRA_MX_1/NotifyingSessionComponent.pyc
