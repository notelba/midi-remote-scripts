...
class NoteRepeatComponent(Component):
    ...
    def __init__(self, note_repeat=None, *a, **k):
        ...
        self._options.selected_color = b'NoteRepeat.RateSelected'
        self._options.unselected_color = b'NoteRepeat.RateUnselected'
    ...
    def _update_aftertouch(self):
        if self._aftertouch and self.is_enabled():
            self._aftertouch.send_value(b'polyphonic')
    ...
    def _get_repeat_rate(self):
        return self.song.view.selected_track.get_data(b'push-note-repeat-rate', DEFAULT_RATE)
    ...
    def _on_selected_option_changed(self, option):
        ...
        self.song.view.selected_track.set_data(b'push-note-repeat-rate', NOTE_REPEAT_RATES[option])
...
class NoteRepeatEnabler(Component):
    ...
    def __init__(self, note_repeat=None, *a, **k):
        ...
        self.note_repeat_component = NoteRepeatComponent(note_repeat=note_repeat, name=b'Note_Repeat', parent=self, is_enabled=False)
        self.__on_selected_track_changed.subject = self.song.view
    ...
    def _set_note_repeat_enabled(self, is_enabled):
        ...
        self.song.view.selected_track.set_data(b'push-note-repeat-enabled', is_enabled)
        self.repeat_button.color = b'DefaultButton.Alert' if is_enabled else b'DefaultButton.On'
    ...
    def _get_note_repeat_enabled(self):
        return self.song.view.selected_track.get_data(b'push-note-repeat-enabled', False)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/note_repeat_component.pyc
