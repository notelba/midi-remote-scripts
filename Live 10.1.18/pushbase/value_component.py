...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\value_component.py
...
class ValueDisplayComponentBase(Component):
    ...
    def __init__(self, display_label=b' ', display_seg_start=0, *a, **k):
...
class ValueComponentBase(Component):
    ...
    def __init__(self, display_label=b' ', display_seg_start=0, encoder_touch_delay=0, *a, **k):
        ...
        self.add_control(b'encoder', encoder)
...
class ValueDisplayComponent(ValueDisplayComponentBase):
    ...
    def __init__(self, property_name=None, subject=None, display_format=b'%f', view_transform=None, graphic_transform=None, *a, **k):
...
class ValueComponent(ValueComponentBase):
    ...
    def __init__(self, property_name=None, subject=None, display_format=b'%f', model_transform=None, view_transform=None, graphic_transform=None, encoder_factor=None, *a, **k):
        self._property_name = property_name
        self._subject = subject
        self._display_format = display_format
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/value_component.pyc
