...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\playhead_component.py
...
class PlayheadComponent(Component):
    ...
    def update(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/playhead_component.pyc
