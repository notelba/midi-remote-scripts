...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\touch_strip_controller.py
...
class TouchStripPitchModComponent(Component, Messenger):
    ...
    def update(self):
        ...
        if self.is_enabled():
            self._update_touch_strip()
            self._update_touch_strip_indication()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/touch_strip_controller.pyc
