...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\selected_track_parameter_provider.py
...
class SelectedTrackParameterProvider(ParameterProvider):
    ...
    def _on_panning_mode_changed(self):
        self.notify_parameters()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/selected_track_parameter_provider.pyc
