...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\colors.py
...
class AnimatedColor(PushColor):
    ...
    def convert_to_midi_value(self):
        raise NotImplementedError, b'Animations cannot be serialized'
...
RGB_COLOR_TABLE = (
 ...
 (126, 11755264),
 (127, 4920578))
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/colors.pyc
