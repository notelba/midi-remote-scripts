...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\browser_util.py
...
def get_selection_for_new_device(selection, insert_left=False):
    ...
    return selected
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/browser_util.pyc
