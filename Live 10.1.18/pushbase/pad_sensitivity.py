...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\pad_sensitivity.py
...
class PadUpdateComponent(Component):
    ...
    def _add_modified_pads(self, pads):
        ...
        self._update_task.restart()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/pad_sensitivity.pyc
