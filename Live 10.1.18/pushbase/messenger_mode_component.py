...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\messenger_mode_component.py
...
class MessengerModesComponent(ModesComponent, Messenger):
    ...
    def muted(self, muted):
        self._muted = muted
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/messenger_mode_component.pyc
