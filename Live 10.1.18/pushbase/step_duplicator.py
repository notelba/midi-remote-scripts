...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\step_duplicator.py
...
class StepDuplicatorComponent(Component, Messenger):
    ...
    def update(self):
        ...
        self._cancel_duplicate()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/step_duplicator.pyc
