...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\browser_modes.py
...
class BrowserHotswapMode(Mode):
    ...
    def _set_hotswap_target(self, hotswap_object):
        ...
        self._application.view.show_view(b'Detail/DeviceChain')
...
def filter_type_between(left, right, supports_midi=False, is_drum_pad=False, supports_instrument=False):
    ...
    return Types.audio_effect_hotswap
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/browser_modes.pyc
