...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\select_playing_clip_component.py
...
class SelectPlayingClipComponent(MessengerModesComponent):
    ...
    def _update_mode(self):
        if not self._selected_track_clip_is_playing():
            ...
            self.selected_mode = b'default'
            self._hide_notification()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/select_playing_clip_component.pyc
