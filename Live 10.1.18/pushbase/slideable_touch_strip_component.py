...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\slideable_touch_strip_component.py
...
class SlideableTouchStripComponent(Component):
    ...
    def _on_contents_changed(self):
        self._touch_strip_array = []
        self._update_touch_strips()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/slideable_touch_strip_component.pyc
