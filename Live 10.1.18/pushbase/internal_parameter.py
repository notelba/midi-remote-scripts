...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\internal_parameter.py
...
class ProxyParameter(Proxy):
    ...
    def __ne__(self, other):
        ...
        return self.proxied_object != other
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/internal_parameter.pyc
