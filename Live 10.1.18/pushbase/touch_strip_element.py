...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\touch_strip_element.py
...
class TouchStripElement(InputControlElement):
    ...
    def __init__(self, touch_button=None, mode_element=None, light_element=None, *a, **k):
        ...
        self._touch_slot = self.register_slot(touch_button, None, b'value')
    ...
    def set_mode(self, mode):
        if not in_range(mode, 0, TouchStripModes.COUNT):
            raise IndexError(b'Invalid Touch Strip Mode %d' % mode)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/touch_strip_element.pyc
