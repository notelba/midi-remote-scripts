...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\melodic_component.py
...
class MelodicComponent(MessengerModesComponent):
    ...
    def _show_notes_information(self, mode=None):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/melodic_component.pyc
