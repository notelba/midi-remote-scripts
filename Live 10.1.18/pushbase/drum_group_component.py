...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\drum_group_component.py
...
class DrumGroupComponent(SlideableTouchStripComponent, DrumGroupComponent, Messenger):
    ...
    def quantize_pitch(self, note):
        self._quantizer.quantize_pitch(note, b'pad')
    ...
    def _update_sensitivity_profile(self):
        profile = b'default' if self._takeover_pads or self.pressed_pads else b'drums'
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/drum_group_component.pyc
