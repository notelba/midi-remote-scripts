...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\step_seq_component.py
...
class StepSeqComponent(Component):
    ...
    def __init__(self, clip_creator=None, skin=None, grid_resolution=None, note_editor_component=None, instrument_component=None, *a, **k):
        ...
        self._skin = skin
        self._playhead_color = b'NoteEditor.Playhead'
        return
    ...
    def _set_playhead_color(self, value):
        self._playhead_color = b'NoteEditor.' + value
        self._update_playhead_color()
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/step_seq_component.pyc
