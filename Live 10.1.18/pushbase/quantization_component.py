...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\quantization_component.py
...
class QuantizationSettingsComponent(Component):
    ...
    record_quantization_toggle_button = ToggleButtonControl(toggled_color=b'Recording.FixedLengthRecordingOn', untoggled_color=b'Recording.FixedLengthRecordingOff')
...
class QuantizationComponent(Component, Messenger):
    ...
    def __init__(self, settings_class=None, quantization_names=QUANTIZATION_NAMES, *a, **k):
        ...
        self.settings = settings_class(name=b'Quantization_Settings', quantization_names=quantization_names, is_enabled=False, parent=self)
    ...
    def action_button(self, button):
        ...
        self._cancel_quantize = False
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/pushbase/quantization_component.pyc
