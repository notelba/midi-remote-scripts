...
class SimpleDeviceParameterComponent(Component):
    bank_select_buttons = FixedRadioButtonGroup(control_count=8, unchecked_color=b'Mode.Device.Bank.Available', checked_color=b'Mode.Device.Bank.Selected')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/novation/simple_device.pyc
