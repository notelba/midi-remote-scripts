...
class NovationControlSurfaceTestBase(ControlSurfaceTestBase):
    ...
    def send_layout_change(self, layout_bytes):
        with interaction_guard():
            self.surface.get_control_by_name(b'Layout_Switch').receive_value(layout_bytes)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/novation/testing/control_surface_test_base.pyc
