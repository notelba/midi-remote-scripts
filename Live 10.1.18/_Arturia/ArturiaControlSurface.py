...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Arturia\ArturiaControlSurface.py
...
BUTTON_MSG_TYPES = {b'note': BUTTON_NOTE_MODE, b'cc': BUTTON_CC_MODE}
...
class ArturiaControlSurface(ControlSurface):
    ...
    def _setup_hardware_button(self, hardware_id, identifier, channel=0, is_momentary=True, msg_type=b'note'):
        """
    ...
    def port_settings_changed(self):
        ...
        self._start_hardware_setup()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Arturia/ArturiaControlSurface.pyc
