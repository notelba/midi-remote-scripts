...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_25_49_61\IdentifyingEncoderElement.py
...
class IdentifyingEncoderElement(EncoderElement):
    ...
    def _update_led(self):
        if self.is_mapped_manually():
            ...
            self.send_value(self._off_value, force=True)
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Axiom_AIR_25_49_61/IdentifyingEncoderElement.pyc
