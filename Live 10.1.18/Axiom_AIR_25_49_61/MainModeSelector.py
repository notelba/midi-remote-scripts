...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_25_49_61\MainModeSelector.py
...
class MainModeSelector(ModeSelectorComponent):
    ...
    def update(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Axiom_AIR_25_49_61/MainModeSelector.pyc
