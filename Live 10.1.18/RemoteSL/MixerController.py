...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\RemoteSL\MixerController.py
    ...
    def _on_arm_changed(self):
        if self.__control_second_button and self.__mixer_controller.support_mkII():
            ...
            self.__mixer_controller.remote_sl_parent().send_midi((
             ...
             self.__index + MX_SECOND_BUTTON_ROW_BASE_CC,
             value))
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/RemoteSL/MixerController.pyc
