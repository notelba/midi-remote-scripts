...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\RemoteSL\RemoteSL.py
...
class RemoteSL:
    ...
    def receive_midi(self, midi_bytes):
        ...
        if midi_bytes[0] & 240 in (NOTE_ON_STATUS, NOTE_OFF_STATUS):
            ...
            print(b'unknown MIDI message %s' % str(midi_bytes))
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/RemoteSL/RemoteSL.pyc
