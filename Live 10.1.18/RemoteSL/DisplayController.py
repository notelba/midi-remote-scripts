...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\RemoteSL\DisplayController.py
...
class DisplayController(RemoteSLComponent):
    ...
    def __generate_strip_string(self, display_string):
        ...
        return ret
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/RemoteSL/DisplayController.pyc
