...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad\MainSelectorComponent.py
...
class MainSelectorComponent(ModeSelectorComponent):
    ...
    def __init__(self, matrix, top_buttons, side_buttons, config_button):
        ...
        self._zooming.name = b'Session_Overview'
        self._matrix = matrix
        ...
        self._sub_modes.name = b'Mixer_Modes'
    ...
    def _init_session(self):
        ...
        for scene_index in range(self._matrix.height()):
            ...
            scene.name = b'Scene_' + str(scene_index)
            for track_index in range(self._matrix.width()):
                ...
                clip_slot.name = str(track_index) + b'_Clip_Slot_' + str(scene_index)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad/MainSelectorComponent.pyc
