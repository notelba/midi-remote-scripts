...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad\Launchpad.py
...
class Launchpad(ControlSurface):
    ...
    def __init__(self, c_instance):
        ...
        with self.component_guard():
            ...
            is_momentary = True
            self._suggested_input_port = b'Launchpad'
            self._suggested_output_port = b'Launchpad'
            self._control_is_with_automap = False
            self._user_byte_write_button = ButtonElement(is_momentary, MIDI_CC_TYPE, 0, 16)
            self._user_byte_write_button.name = b'User_Byte_Button'
            ...
            top_buttons[0].name = b'Bank_Select_Up_Button'
            top_buttons[1].name = b'Bank_Select_Down_Button'
            top_buttons[2].name = b'Bank_Select_Left_Button'
            top_buttons[3].name = b'Bank_Select_Right_Button'
            top_buttons[4].name = b'Session_Button'
            top_buttons[5].name = b'User1_Button'
            top_buttons[6].name = b'User2_Button'
            top_buttons[7].name = b'Mixer_Button'
            side_buttons[0].name = b'Vol_Button'
            side_buttons[1].name = b'Pan_Button'
            side_buttons[2].name = b'SndA_Button'
            side_buttons[3].name = b'SndB_Button'
            side_buttons[4].name = b'Stop_Button'
            side_buttons[5].name = b'Trk_On_Button'
            side_buttons[6].name = b'Solo_Button'
            side_buttons[7].name = b'Arm_Button'
            self._selector = MainSelectorComponent(matrix, tuple(top_buttons), tuple(side_buttons), self._config_button)
            self._selector.name = b'Main_Modes'
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad/Launchpad.pyc
