...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad\PreciseButtonSliderElement.py
...
class PreciseButtonSliderElement(ButtonSliderElement):
    ...
    def _on_parameter_changed(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad/PreciseButtonSliderElement.pyc
