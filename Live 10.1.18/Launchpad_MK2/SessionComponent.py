...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_MK2\SessionComponent.py
...
class SessionComponent(SessionComponentBase):
    ...
    def _enable_skinning(self):
        ...
        self.set_stopped_clip_value(b'Session.StoppedClip')
        scroll_components = (
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_MK2/SessionComponent.pyc
