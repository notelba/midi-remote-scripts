...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_MK2\SliderElement.py
...
class SliderElement(SliderElementBase):
    ...
    def _setup_fader(self):
        ...
        self._send_midi(msg)
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_MK2/SliderElement.pyc
