...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_MK2\ModeUtils.py
...
def to_class_name(mode_name):
    return (b'').join(map(lambda s: s.capitalize(), mode_name.split(b'_')))
...
class SkinableBehaviourMixin(ModeButtonBehaviour):
    ...
    def update_button(self, component, mode, selected_mode):
        ...
        if is_selected:
            ...
            value_status = b'GroupOn'
        button.set_light(b'Mode.%s.%s' % (mode_color, value_status))
...
class NotifyingModesComponent(ModesComponent):
    ...
    def send_switch_layout_message(self, mode=None):
        ...
        try:
            ...
            print(b"Couldn't switch layout on hardware")
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_MK2/ModeUtils.pyc
