...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\APC20\ShiftableSelectorComponent.py
...
class ShiftableSelectorComponent(ModeSelectorComponent):
    ...
    def _on_note_mode_changed(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/APC20/ShiftableSelectorComponent.pyc
