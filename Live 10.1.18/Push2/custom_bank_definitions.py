...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\custom_bank_definitions.py
...
BANK_DEFINITIONS = {b'AudioEffectGroupDevice': RACK_BANKS, 
   ...
   b'Operator': IndexedDict((
               ...
               (
                ...
                {BANK_PARAMETERS_KEY: (
                                       ...
                                       b'Shaper Mix',
                                       b'Fe Mode',
                                       use(b'Fe Retrig').if_parameter(b'Fe Mode').has_value(b'Beat').else_use(b'Fe Retrig').if_parameter(b'Fe Mode').has_value(b'Sync').else_use(b'Fe Loop').if_parameter(b'Fe Mode').has_value(b'Loop').else_use(b''),
                                       b'',
                                       b'')}),
               (
                b'LFO',
   ...
   b'MultibandDynamics': IndexedDict((
                        (
                         BANK_MAIN_KEY,
                         {BANK_PARAMETERS_KEY: (
                                                b'Above Threshold (Low)',
                                                b'Above Ratio (Low)',
                                                b'Above Threshold (Mid)',
                                                b'Above Ratio (Mid)',
                                                b'Above Threshold (High)',
                                                b'Above Ratio (High)',
                                                b'Master Output',
                                                b'Amount')}),
                        (
...
PARAMETERS_BLACKLIST_FOR_CPP_SANITY_CHECK = {b'OriginalSimpler': (
   ...
   b'InstrumentVector': (
                       ...
                       b'Mod Env View',
                       b'Modulation Target Names',
                       b'Amp Env Mod Amount',
                       b'Env 2 Mod Amount',
                       b'Env 3 Mod Amount',
                       b'Lfo 1 Mod Amount',
                       b'Lfo 2 Mod Amount',
                       b'MIDI Velocity Mod Amount',
                       b'MIDI Note Mod Amount',
                       b'MIDI Pitch Bend Mod Amount',
                       b'MIDI Aftertouch Mod Amount',
                       b'MIDI Mod Wheel Mod Amount',
                       b'MIDI Random On Note On',
                       b'Current Mod Target',
                       b'Unison Mode',
                       b'Unison Voices',
                       b'Mono On',
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/custom_bank_definitions.pyc
