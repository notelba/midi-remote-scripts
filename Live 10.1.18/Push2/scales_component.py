...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\scales_component.py
...
class ScalesComponent(Component):
    ...
    def __init__(self, note_layout=None, *a, **k):
        ...
        self._layouts = (Layout(b'4ths', 3), Layout(b'3rds', 2), Layout(b'Sequential', None))
...
class ScalesEnabler(Component):
    ...
    def on_enabled_changed(self):
        ...
        if not self.is_enabled():
            self._exit_dialog_mode()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/scales_component.pyc
