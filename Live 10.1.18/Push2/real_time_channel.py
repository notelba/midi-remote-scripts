...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\real_time_channel.py
...
class RealTimeDataComponent(Component):
    ...
    def detach(self):
        if not self._valid and self._real_time_channel_id != b'':
    ...
    def attach(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/real_time_channel.pyc
