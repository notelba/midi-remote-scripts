...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\session_component.py
...
class ClipSlotComponent(SpecialClipSlotComponent):
    ...
    def _feedback_value(self, track, slot_or_clip):
        ...
        if slot_or_clip.is_triggered and not slot_or_clip.will_record_on_start:
            ...
            return b'Session.EmptySlotTriggeredPlay'
...
class SceneComponent(SpecialSceneComponent):
    ...
    def build_clip_slot_list(self):
        ...
        def slot_for_track(mixable):
            if not hasattr(mixable, b'clip_slots') or len(mixable.clip_slots) == 0:
                return
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/session_component.pyc
