...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\track_selection.py
...
class SelectedMixerTrackProvider(EventObject):
    ...
    def selected_mixer_track(self, track_or_chain):
        unwrapped_track = getattr(track_or_chain, b'proxied_object', track_or_chain)
...
class SessionRingTrackProvider(SessionRingComponent, ItemProvider):
    ...
    def controlled_tracks(self):
        return [ getattr(track, b'proxied_object', track) for track in self.items ]
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/track_selection.pyc
