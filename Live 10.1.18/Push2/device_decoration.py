...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\device_decoration.py
...
class SimplerDecoratedPropertiesCopier(object):
    ...
    def _apply_nested_properties(self, decorated_object):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/device_decoration.pyc
