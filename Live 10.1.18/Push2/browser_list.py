...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\browser_list.py
    ...
    def selected_index(self, value):
        if value != self._selected_index:
            ...
            if value < -1 or value >= num_children:
                raise IndexError(b'Index %i must be in [-1..%i]' % (value, num_children - 1))
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/browser_list.pyc
