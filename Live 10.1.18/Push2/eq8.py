...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\eq8.py
...
class Eq8DeviceDecorator(EventObject, LiveObjectDecorator):
    ...
    def __init__(self, *a, **k):
        ...
        self.left_right_curve_switch_option = DeviceSwitchOption(name=b'Left/Right', labels=[b'Left', b'Right'], parameter=self.edit_switch)
        self.mid_side_curve_switch_option = DeviceSwitchOption(name=b'Mid/Side', labels=[b'Mid', b'Side'], parameter=self.edit_switch)
...
class Eq8DeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    def _shrink_parameters(self):
        return [True] * 8
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/eq8.pyc
