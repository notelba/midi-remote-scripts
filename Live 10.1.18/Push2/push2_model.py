...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\push2_model.py
...
class Root(generate_mrs_model(RootModel)):
    ...
    def to_json(self, root_keys=None):
        if root_keys is None:
            ...
            return res
            return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/push2_model.pyc
