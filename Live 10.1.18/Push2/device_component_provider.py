...
DEVICE_COMPONENT_MODES = {b'Generic': GenericDeviceComponent, 
   ...
   b'ChannelEq': ChannelEqDeviceComponent, 
   b'Delay': DelayDeviceComponent}
...
class DeviceComponentProvider(ModesComponent):
    ...
    def disconnect(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/device_component_provider.pyc
