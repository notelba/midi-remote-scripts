...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\echo.py
...
class EchoDeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    def _adjustment_view_data(self):
        ...
        return {b'AdjustingTunnelLeft': adjusting_tunnel_left, b'AdjustingTunnelRight': adjusting_tunnel_right, 
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/echo.pyc
