...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\pad_velocity_curve.py
...
class PadVelocityCurveSender(Component):
    ...
    def __init__(self, curve_sysex_element=None, threshold_sysex_element=None, settings=None, chunk_size=None, *a, **k):
        ...
        self.register_slot(settings, self._on_setting_changed, b'sensitivity')
        self.register_slot(settings, self._on_setting_changed, b'gain')
        self.register_slot(settings, self._on_setting_changed, b'dynamics')
    ...
    def _on_send_task_finished(self):
        if self._settings_changed:
            self.send()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/pad_velocity_curve.pyc
