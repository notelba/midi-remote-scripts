...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\device_options.py
...
class DeviceSwitchOption(DeviceTriggerOption):
    ...
    def set_parameter(self, parameter):
        ...
        if liveobj_valid(parameter) and parameter.is_quantized:
            self._parameter_labels = [ item.replace(b' ', b'') for item in parameter.value_items ]
...
class DeviceOnOffOption(DeviceTriggerOption):
    ...
    def __init__(self, name=None, property_host=None, value_property_name=b'value', state_property_name=b'state', *a, **k):
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/device_options.pyc
