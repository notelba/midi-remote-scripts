...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\clip_decoration.py
...
class ClipPositions(EventObject):
    ...
    def _update_start_end_note_times(self):
        ...
        start_times, end_times = zip(*[ (start_time, start_time + duration) for _, start_time, duration, _, _ in all_notes ]) if len(all_notes) > 0 else (
         [
...
class ClipDecoration(EventObject, LiveObjectDecorator):
    ...
    def __init__(self, *a, **k):
        ...
        self._zoom_parameter = parameter_type(name=b'Zoom', parent=self._live_object, clip=self)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/clip_decoration.pyc
