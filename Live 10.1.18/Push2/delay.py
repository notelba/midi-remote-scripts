...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\delay.py
...
class DelayDeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    def _initial_visualisation_view_data(self):
        ...
        return view_data
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/delay.pyc
