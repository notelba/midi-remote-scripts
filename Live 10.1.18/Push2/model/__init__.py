...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\model\__init__.py
...
class RealTimeChannel(Binding):
    channel_id = view_property(unicode, b'')
    object_id = view_property(unicode, b'')
...
class Track(Binding):
    ...
    outputRouting = view_property(unicode, b'')
    id = id_property()
...
class Device(Binding):
    ...
    name = view_property(unicode, b'')
    navigation_name = view_property(unicode, b'')
    nestingLevel = view_property(int, 0)
    is_active = view_property(bool, False)
    id = id_property()
    class_name = view_property(unicode, b'')
    icon = view_property(unicode, b'')
...
class TransportState(Binding):
    ...
    count_in_real_time_channel_id = view_property(unicode, b'')
...
class MixerSelectionListModel(Binding):
    ...
    visible = view_property(bool, False)
    items = view_property(listof(ItemSlotModel))
    selectedItem = view_property(unicode, b'')
...
class DeviceParameter(Binding):
    ...
    name = view_property(unicode, b'')
    original_name = view_property(unicode, b'')
    ...
    displayValue = view_property(unicode, b'')
    unit = view_property(unicode, b'')
    id = id_property()
...
class SimplerProperties(Binding):
    ...
    slices = view_property(listmodel(Slice))
    selected_slice = view_property(Slice)
    playhead_real_time_channel_id = view_property(unicode, b'')
    waveform_real_time_channel_id = view_property(unicode, b'')
    warping = view_property(bool, False)
...
class DeviceParameterListModel(ViewModel):
    visible = view_property(bool, False)
    deviceType = view_property(unicode, b'')
    device = view_property(Device)
...
class DeviceVisualisationModel(Binding):
    ...
    visualisation_real_time_channel_id = view_property(unicode, b'')
...
class SimplerDeviceViewModel(ViewModel):
    ...
    bank_view_description = view_property(unicode, b'')
...
class RoutingChannel(Binding):
    id = id_property()
    name = view_property(unicode, b'')
    layout = view_property(unicode, b'')
...
class TrackControlModel(Binding):
    ...
    track_control_mode = view_property(unicode, b'')
...
class BrowserModel(Binding):
    ...
    context_text = view_property(unicode, b'')
    context_color_index = view_property(int, -1)
    context_display_type = view_property(unicode, b'')
...
class Notification(Binding):
    visible = view_property(bool, False)
    message = view_property(unicode, b'')


class RealTimeClient(Binding):
    clientId = view_property(unicode, b'')


class ConvertModel(Binding):
    ADAPTER = VisibleAdapter
    source_color_index = view_property(int, -1)
    source_name = view_property(unicode, b'')
    visible = view_property(bool, False)
...
class ScalesModel(Binding):
    ADAPTER = VisibleAdapter
    visible = view_property(bool, False)
    scale_names = view_property(listof(unicode), b'')
    selected_scale_index = view_property(int, -1)
    layout_names = view_property(listof(unicode), b'')
    selected_layout_index = view_property(int, 0)
    root_note_names = view_property(listof(unicode), b'')
...
class ModeState(Binding):
    main_mode = view_property(unicode, b'')
    mix_mode = view_property(unicode, b'')
    global_mix_mode = view_property(unicode, b'')
    device_mode = view_property(unicode, b'')
...
class GeneralSettingsModel(Binding):
    workflow = view_property(unicode, b'scene')
...
class SetupModel(Binding):
    ...
    selected_mode = view_property(unicode, b'')
...
class ValueModel(Binding):
    ADAPTER = VisibleAdapter
    visible = view_property(bool, False)
    value_string = view_property(unicode, b'')
...
class FirmwareVersion(Binding):
    ...
    release_type = view_property(unicode, b'')
...
class FirmwareUpdateModel(Binding):
    ADAPTER = VisibleAdapter
    visible = view_property(bool, False)
    firmware_file = view_property(unicode, b'')
    data_file = view_property(unicode, b'')
    state = view_property(unicode, b'')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/model/__init__.pyc
