...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\decoration.py
...
class TrackDecoratorFactory(DecoratorFactory):
    ...
    def _get_chain_nesting_level(self, chain):
        ...
        if hasattr(parent_chain_or_track, b'group_track'):
            return self._get_nesting_level(parent_chain_or_track) + 1
        else:
            if hasattr(parent_chain_or_track, b'canonical_parent') and hasattr(parent_chain_or_track.canonical_parent, b'canonical_parent'):
    ...
    def _get_decorated_track(self, track):
        ...
        if getattr(track, b'group_track', None):
        ...
        return decorated
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/decoration.pyc
