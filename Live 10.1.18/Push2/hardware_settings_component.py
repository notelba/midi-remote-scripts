...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\hardware_settings_component.py
...
class HardwareSettingsComponent(Component):
    ...
    def send(self):
        ...
        self._display_brightness_element.send_value(self._settings.display_brightness)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/hardware_settings_component.pyc
