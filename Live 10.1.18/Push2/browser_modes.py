...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\browser_modes.py
    ...
    def _enter_hotswap_mode(self):
        ...
        if liveobj_valid(hotswap_target):
            if isinstance(hotswap_target, Live.DrumPad.DrumPad):
                self._drum_group_component.hotswap_indication_mode = b'current_pad'
                ...
                self._drum_group_component.hotswap_indication_mode = b'all_pads'
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/browser_modes.pyc
