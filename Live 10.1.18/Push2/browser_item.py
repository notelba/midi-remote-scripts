...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\browser_item.py
...
class BrowserItem(object):
    ...
    def __init__(self, name=b'', icon=b'', children=None, is_loadable=False, is_selected=False, is_device=False, contained_item=None, enable_wrapping=True, *a, **k):
...
class ProxyBrowserItem(Proxy):
    ...
    def __init__(self, enable_wrapping=True, icon=b'', *a, **k):
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/browser_item.pyc
