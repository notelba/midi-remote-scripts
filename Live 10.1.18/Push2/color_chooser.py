...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\color_chooser.py
...
class ColorChooserComponent(Component, Messenger):
    ...
    def _render_color_palette(self, selected_color_index):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push2/color_chooser.pyc
