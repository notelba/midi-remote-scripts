...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\MessageScheduler.py
...
class MessageScheduler(object):
    ...
    def disconnect(self, owner):
        if self._state != b'idle':
            ...
            self._process_queue()
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/MessageScheduler.pyc
