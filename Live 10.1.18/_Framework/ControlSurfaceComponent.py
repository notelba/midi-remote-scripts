...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ControlSurfaceComponent.py
...
class ControlSurfaceComponent(ControlManager, Subject):
    ...
    def __init__(self, name=b'', register_component=None, song=None, layer=None, is_enabled=True, is_root=False, *a, **k):
    ...
    def _internal_on_enabled_changed(self):
        if self._layer:
            if self.is_enabled():
                ...
                assert grabbed, b'Only one component can use a layer at atime'
            else:
    ...
    def _unregister_timer_callback(self, callback, parent_task_group=None):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ControlSurfaceComponent.pyc
