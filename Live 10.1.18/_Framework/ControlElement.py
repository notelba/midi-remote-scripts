...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ControlElement.py
        ...
        while self._ownership_changes:
            ...
            for (control, client, status), _ in notifications:
                try:
                    ...
                    log_message(b'Error when trying to give control:', control.name)
                    traceback.print_exc()
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ControlElement.pyc
