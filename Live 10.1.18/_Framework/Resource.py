...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\Resource.py
...
class ExclusiveResource(Resource):
    ...
    def grab(self, client, *a, **k):
        assert client is not None, b'Someone has to adquire resource'
        if self._owner == None:
    ...
    def on_received(self, client, *a, **k):
        raise NotImplemented, b'Override or pass callback'
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/Resource.pyc
