...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\DrumGroupComponent.py
...
class DrumGroupComponent(SlideComponent, Slideable):
    ...
    def delete_pitch(self, drum_pad):
        ...
        raise NotImplementedError
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/DrumGroupComponent.pyc
