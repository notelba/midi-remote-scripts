...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\BackgroundComponent.py
...
class ModifierBackgroundComponent(BackgroundComponent):
    ...
    def _reset_control(self, control):
        if len(control.resource.owners) > 1:
            ...
            control.reset()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/BackgroundComponent.pyc
