...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\Disconnectable.py
...
class disconnectable(object):
    ...
    def __exit__(self, *a, **k):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/Disconnectable.pyc
