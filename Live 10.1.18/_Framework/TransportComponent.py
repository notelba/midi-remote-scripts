...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\TransportComponent.py
...
class TransportComponent(CompoundComponent):
    ...
    def __init__(self, play_toggle_model_transform=const(True), *a, **k):
        ...
        song = self.song()
        self._loop_toggle, self._punch_in_toggle, self._punch_out_toggle, self._record_toggle, self._play_toggle, self._stop_toggle, self._nudge_down_toggle, self._nudge_up_toggle, self._metronome_toggle, self._arrangement_overdub_toggle, self._overdub_toggle = self.register_components(ToggleComponent(b'loop', song), ToggleComponent(b'punch_in', song, is_momentary=True), ToggleComponent(b'punch_out', song, is_momentary=True), ToggleComponent(b'record_mode', song), ToggleComponent(b'is_playing', song, model_transform=play_toggle_model_transform), ToggleComponent(b'is_playing', song, model_transform=const(False), view_transform=const(False)), ToggleComponent(b'nudge_down', song, is_momentary=True), ToggleComponent(b'nudge_up', song, is_momentary=True), ToggleComponent(b'metronome', song), ToggleComponent(b'arrangement_overdub', song), ToggleComponent(b'overdub', song))
        return
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/TransportComponent.pyc
