...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ModeSelectorComponent.py
...
class ModeSelectorComponent(ControlSurfaceComponent):
    ...
    def _on_timer(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ModeSelectorComponent.pyc
