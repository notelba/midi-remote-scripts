...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\Dependency.py
...
def get_dependency_for(obj, name, default=None):
    ...
    if accessor is not None:
        ...
        raise DependencyError(b'Required dependency %s not provided for %s' % (name, str(obj)))
        return
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/Dependency.pyc
