...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\Task.py
        ...
        for task in self._tasks:
            if not task.is_killed:
                try:
                    ...
                    task.kill()
                    log_message(b'Error when executing task')
                    traceback.print_exc()
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/Task.pyc
