...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\SessionZoomingComponent.py
...
class SessionZoomingComponent(CompoundComponent):
    ...
    def __init__(self, session=None, enable_skinning=False, *a, **k):
        ...
        self.register_slot(self._session, self._on_session_offset_changes, b'offset')
        if enable_skinning:
            self._enable_skinning()
        return

    def _enable_skinning(self):
        self.set_stopped_value(b'Zooming.Stopped')
        self.set_selected_value(b'Zooming.Selected')
        self.set_playing_value(b'Zooming.Playing')
        self.set_empty_value(b'Zooming.Empty')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/SessionZoomingComponent.pyc
