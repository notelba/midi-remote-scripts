...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\DrumRackComponent.py
...
class DrumRackComponent(ControlSurfaceComponent):
    ...
    def set_pads(self, matrix):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/DrumRackComponent.pyc
