...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ButtonElement.py
...
class ButtonElement(InputControlElement, ButtonElementMixin):
    ...
    def disconnect(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ButtonElement.pyc
