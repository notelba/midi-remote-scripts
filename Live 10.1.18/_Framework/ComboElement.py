...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ComboElement.py
...
class DoublePressElement(WrapperElement):
    ...
    @subject_slot(b'break_double_press')
...
class ToggleElement(WrapperElement):
    ...
    def _update_toggled(self):
        ...
        if self._wrapped_control != None:
            self.register_control_element(self._wrapped_control)
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ComboElement.pyc
