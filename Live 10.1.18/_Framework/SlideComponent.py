...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\SlideComponent.py
...
class SlideComponent(CompoundComponent, Scrollable):
    ...
    def _on_position_changed(self):
        self._position_scroll.update()
        self._page_scroll.update()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/SlideComponent.pyc
