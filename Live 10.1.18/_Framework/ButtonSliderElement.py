...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ButtonSliderElement.py
...
class ButtonSliderElement(SliderElement, SlotManager):
    ...
    def _on_parameter_changed(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ButtonSliderElement.pyc
