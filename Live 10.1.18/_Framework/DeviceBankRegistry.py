...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\DeviceBankRegistry.py
...
class DeviceBankRegistry(Subject):
    ...
    def _find_device_bank_key(self, device):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/DeviceBankRegistry.pyc
