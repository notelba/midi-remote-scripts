...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\ScrollComponent.py
...
class ScrollComponent(ControlSurfaceComponent, Scrollable):
    ...
    default_scroll_skin = dict(color=b'Enabled', pressed_color=b'Pressed', disabled_color=False)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/ScrollComponent.pyc
