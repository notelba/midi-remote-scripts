...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Framework\EncoderElement.py
...
class EncoderElement(InputControlElement):
    ...
    __subject_events__ = (
     SubjectEvent(name=b'normalized_value', signal=InputSignal),)
...
class FineGrainWithModifierEncoderElement(WrapperElement):
    ...
    @subject_slot(b'normalized_value')
    ...
    def set_sensitivities(self, default, modified):
        ...
        self._enforce_control_invariant()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Framework/EncoderElement.pyc
