...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\RemoteSL_Classic\DisplayController.py
...
class DisplayController(RemoteSLComponent):
            ...
            if row_id == 1 or row_id == 2:
                ...
                for p in parameters:
                    if p:
                        ...
                        message_string += self.__generate_strip_string(b'')
    ...
    def __generate_strip_string(self, display_string):
        ...
        if not display_string:
            return b' ' * NUM_CHARS_PER_DISPLAY_STRIP
        if len(display_string.strip()) > NUM_CHARS_PER_DISPLAY_STRIP - 1 and display_string.endswith(b'dB') and display_string.find(b'.') != -1:
        ...
        return ret
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/RemoteSL_Classic/DisplayController.pyc
