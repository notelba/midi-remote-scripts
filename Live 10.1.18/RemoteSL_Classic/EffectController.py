...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\RemoteSL_Classic\EffectController.py
...
class EffectChannelStrip():
    ...
    def on_encoder_moved(self, cc_value):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/RemoteSL_Classic/EffectController.pyc
