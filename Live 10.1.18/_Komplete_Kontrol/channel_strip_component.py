...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Komplete_Kontrol\channel_strip_component.py
...
volume_pattern = re.compile(b'-*\\d+.\\d+')
...
class ChannelStripComponent(ChannelStripComponentBase):
    ...
    def _update_track_volume_data_source(self):
        ...
        if liveobj_valid(self._track):
            ...
            found_string = (b'').join(volume_pattern.findall(volume_string))
            if found_string:
                volume_string = b'%s dB' % round(float(found_string), 1)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Komplete_Kontrol/channel_strip_component.pyc
