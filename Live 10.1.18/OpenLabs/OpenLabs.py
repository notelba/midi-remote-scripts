...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\OpenLabs\OpenLabs.py
...
class OpenLabs(ControlSurface):
    ...
    def __init__(self, c_instance):
        ...
        with self.component_guard():
            ...
            self._suggested_input_port = b'Open Labs Midi Driver'
            self._suggested_output_port = b''
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/OpenLabs/OpenLabs.pyc
