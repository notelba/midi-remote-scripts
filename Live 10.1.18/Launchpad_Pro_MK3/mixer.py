...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro_MK3\mixer.py
...
class MixerComponent(MixerComponentBase):
    send_select_buttons = FixedRadioButtonGroup(control_count=8, unchecked_color=b'Mode.Sends.Bank.Available')
    ...
    @listens_group(b'color')
    def __on_return_track_color_changed(self, _):
        self._update_send_control_colors()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro_MK3/mixer.pyc
