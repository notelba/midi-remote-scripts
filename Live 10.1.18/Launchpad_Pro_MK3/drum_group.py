...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro_MK3\drum_group.py
...
class DrumGroupComponent(DrumGroupComponentBase):
    delete_button = ButtonControl(color=b'Action.Delete', pressed_color=b'Action.DeletePressed')
    ...
    def _update_scroll_button(self, button, can_scroll):
        button.enabled = True
        button.color = b'DrumGroup.Navigation' if can_scroll else b'DefaultButton.Disabled'
        button.pressed_color = b'DrumGroup.NavigationPressed' if can_scroll else b'DefaultButton.Disabled'

    @listens(b'can_perform_clip_actions')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro_MK3/drum_group.pyc
