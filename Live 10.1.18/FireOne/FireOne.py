...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\FireOne\FireOne.py
...
class FireOne:
    ...
    def __jog_dial_message(self, cc_no, cc_value):
        ...
        if not cc_value in range(128):
            raise AssertionError
            moved_forward = cc_value in range(1, 64)
            if self.__shift_pressed or self.application().view.is_view_visible(b'Session'):
    ...
    def __f_key_message(self, f_key, value):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/FireOne/FireOne.pyc
