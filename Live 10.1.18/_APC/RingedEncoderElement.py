...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_APC\RingedEncoderElement.py
    ...
    def _update_ring_mode(self):
        if self._ring_mode_button != None:
            if self.is_mapped_manually():
                ...
                self._ring_mode_button.send_value(RING_OFF_VALUE, force=True)
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_APC/RingedEncoderElement.pyc
