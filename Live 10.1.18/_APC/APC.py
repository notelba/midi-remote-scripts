...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_APC\APC.py
...
class APC(ControlSurface):
    ...
    def __init__(self, *a, **k):
        ...
        self._suggested_input_port = b'Akai ' + self.__class__.__name__
        self._suggested_output_port = b'Akai ' + self.__class__.__name__
        self._device_id = 0
    ...
    def _log_version(self, version_bytes):
        message = self.__class__.__name__ + b': Got response from controller, version ' + str((version_bytes[0] << 4) + version_bytes[1]) + b'.' + str((version_bytes[2] << 4) + version_bytes[3])
    ...
    def _product_model_id_byte(self):
        raise AssertionError, b'Function _product_model_id_byte must be overridden by subclass'
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_APC/APC.pyc
