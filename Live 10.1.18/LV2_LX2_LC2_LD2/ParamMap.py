...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\ParamMap.py
...
class ParamMap:
    ...
    def remove_mappings(self):
        ...
        self.params_with_listener = []
        self.param_callbacks = []
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/LV2_LX2_LC2_LD2/ParamMap.pyc
