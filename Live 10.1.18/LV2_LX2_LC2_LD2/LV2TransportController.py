...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\LV2TransportController.py
...
class LV2TransportController(FaderfoxTransportController):
    ...
    def set_slot_launch_led(self, track_idx, clip_idx, playing):
        self.log(b'set slot launch led %s %s %s' % (track_idx, clip_idx, playing))
    ...
    def disconnect(self):
        if self.__use_slot_led__:
            self.remove_clip_listeners()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/LV2_LX2_LC2_LD2/LV2TransportController.pyc
