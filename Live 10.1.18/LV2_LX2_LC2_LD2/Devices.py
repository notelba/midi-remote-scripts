...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\LV2_LX2_LC2_LD2\Devices.py
...
DEVICE_BOB_DICT = {b'AudioEffectGroupDevice': RCK_BOBS, 
   ...
   b'UltraAnalog': ANA_BOBS, 
   b'StringStudio': TEN_BOBS, 
   b'LoungeLizard': ELEC_BOBS, 
   b'ProxyInstrumentDevice': EXTINST_BOBS, 
   ...
   b'ProxyAudioEffectDevice': EXTEFFECT_BOBS, 
...
DEVICE_DICT = {b'AudioEffectGroupDevice': RCK_BANKS, 
   ...
   b'Vinyl': VDS_BANKS, 
   b'Gate': GTE_BANKS}
FIVETOSIX_DICT = {b'Auto Filter': b'AutoFilter', 
   b'Auto Pan': b'AutoPan', 
   b'Beat Repeat': b'BeatRepeat', 
   b'Chorus': b'Chorus', 
   b'Compressor I': b'Compressor', 
   b'Compressor II': b'Compressor2', 
   b'EQ Four': b'Eq8', 
   b'EQ Three': b'FilterEQ3', 
   b'Erosion': b'Erosion', 
   b'Filter Delay': b'FilterDelay', 
   b'Flanger': b'Flanger', 
   b'Gate': b'Gate', 
   b'Grain Delay': b'GrainDelay', 
   b'Phaser': b'Phaser', 
   b'Redux': b'Redux', 
   b'Resonators': b'Resonator', 
   b'Reverb': b'Reverb', 
   b'Saturator': b'Saturator', 
   b'Utility': b'StereoGain', 
   b'Vinyl Distortion': b'Vinyl', 
   b'Arpeggiator': b'MidiArpeggiator', 
   b'Chord': b'MidiChord', 
   b'Pitch': b'MidiPitcher', 
   b'Random': b'MidiRandom', 
   b'Scale': b'MidiScale', 
   b'Velocity': b'MidiVelocity', 
   b'Simpler': b'OriginalSimpler', 
   b'Impulse': b'InstrumentImpulse', 
   b'Operator': b'Operator'}
INVERT_QUANT_PARAM = {b'FilterDelay.1 Beat Delay': 1, 
   b'FilterDelay.2 Beat Delay': 1, 
   b'FilterDelay.3 Beat Delay': 1}
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/LV2_LX2_LC2_LD2/Devices.pyc
