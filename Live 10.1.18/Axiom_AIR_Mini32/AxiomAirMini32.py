...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_Mini32\AxiomAirMini32.py
...
class SpecialChanStripComponent(ChannelStripComponent):
    ...
    def set_arm_button(self, button):
        ...
        if button != self._arm_button:
            ...
            self.update()
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Axiom_AIR_Mini32/AxiomAirMini32.pyc
