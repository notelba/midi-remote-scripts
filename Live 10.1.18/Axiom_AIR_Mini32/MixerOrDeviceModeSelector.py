...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_Mini32\MixerOrDeviceModeSelector.py
    ...
    def update(self):
        ...
        if self.is_enabled():
            if self._mode_index == 0:
                ...
                self._mixer.selected_strip().set_arm_button(None)
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Axiom_AIR_Mini32/MixerOrDeviceModeSelector.pyc
