...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_AIR_Mini32\DeviceNavComponent.py
    ...
    def _nav_value(self, value, sender):
        if self.is_enabled():
            if not sender.is_momentary() or value != 0:
                ...
                if not app_view.is_view_visible(b'Detail') or not app_view.is_view_visible(b'Detail/DeviceChain'):
                    app_view.show_view(b'Detail')
                    app_view.show_view(b'Detail/DeviceChain')
                else:
                    ...
                    app_view.scroll_view(direction, b'Detail/DeviceChain', not modifier_pressed)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Axiom_AIR_Mini32/DeviceNavComponent.pyc
