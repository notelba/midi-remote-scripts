...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launch_Control_XL\ButtonElement.py
...
class ButtonElement(ButtonElementBase):
    ...
    def send_value(self, value, **k):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launch_Control_XL/ButtonElement.pyc
