...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\UC33e\__init__.py
...
def get_capabilities():
    return {CONTROLLER_ID_KEY: controller_id(vendor_id=2637, product_ids=[245], model_name=b'UC-33 USB MIDI Controller'), 
       PORTS_KEY: [
                 inport(props=[NOTES_CC, SCRIPT]),
                 inport(props=[NOTES_CC]),
                 outport(props=[SCRIPT])]}
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/UC33e/__init__.pyc
