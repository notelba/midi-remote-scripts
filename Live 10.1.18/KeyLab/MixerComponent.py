...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\KeyLab\MixerComponent.py
...
class MixerComponent(MixerComponentBase):
    ...
    def _select_next_track(self):
        ...
        index = list(all_tracks).index(selected_track)
        self.song().view.selected_track = all_tracks[(index + 1)]
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/KeyLab/MixerComponent.pyc
