...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Novation_Impulse\ShiftableTransportComponent.py
...
class ShiftableTransportComponent(TransportComponent):
    ...
    def _rwd_value(self, value):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Novation_Impulse/ShiftableTransportComponent.pyc
