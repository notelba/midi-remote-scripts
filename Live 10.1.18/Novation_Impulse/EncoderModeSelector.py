...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Novation_Impulse\EncoderModeSelector.py
    ...
    def _mixer_value(self, value):
        if not value in range(128):
            ...
            if self.is_enabled() and self._device_mode and (value > 0 or not self._mixer_button.is_momentary()):
                ...
                self.update()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Novation_Impulse/EncoderModeSelector.pyc
