...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Novation_Impulse\PeekableEncoderElement.py
...
class PeekableEncoderElement(EncoderElement):
    ...
    def install_connections(self, install_translation_callback, install_mapping_callback, install_forwarding_callback):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Novation_Impulse/PeekableEncoderElement.pyc
