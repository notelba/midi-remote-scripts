...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Akai_Force_MPC\clip_slot.py
...
class ClipSlotComponent(ClipSlotComponentBase):
    ...
    def __init__(self, *a, **k):
        ...
        self._empty_slot_with_stop_button_color = b'Session.ClipEmptyWithStopButton'
        view = self.song.view
    ...
    def _feedback_value(self, track, slot_or_clip):
        if slot_or_clip.is_triggered:
            ...
            if slot_or_clip.color != None or getattr(slot_or_clip, b'controls_other_clips', True):
    ...
    def _update_clip_name_display(self):
        ...
        self.clip_name_display[0] = clip_slot.clip.name if liveobj_valid(clip_slot) and self.has_clip() else b''
    ...
    def _update_clip_color_control(self):
        ...
        if liveobj_valid(clip_slot):
            if self.has_clip():
                color_to_send = b'Session.ClipSelected' if self.select_button_is_pressed and clip_slot == self.song.view.highlighted_clip_slot else clip_slot.clip.color_index + LIVE_COLOR_TABLE_INDEX_OFFSET
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Akai_Force_MPC/clip_slot.pyc
