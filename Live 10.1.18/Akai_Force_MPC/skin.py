...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Akai_Force_MPC\skin.py
...
class MPCColors(ColorsBase):
    ...
    class Mixer(ColorsBase.Mixer):
        ArmOn = Color(1)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Akai_Force_MPC/skin.pyc
