...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Akai_Force_MPC\session.py
...
def _set_method(component, control_name):
    set_method = getattr(component, (b'set_{}').format(control_name), None)
    if not set_method:
...
class SessionComponent(SessionComponentBase):
    ...
    def set_clip_color_controls(self, controls):
        self._set_clip_controls(b'clip_color_control', controls)

    def set_clip_name_displays(self, displays):
        self._set_clip_controls(b'clip_name_display', displays)

    def set_scene_name_displays(self, displays):
        self._set_scene_controls(b'scene_name_display', displays)

    def set_scene_color_controls(self, controls):
        self._set_scene_controls(b'scene_color_control', controls)

    def set_scene_selection_controls(self, controls):
        self._set_scene_controls(b'scene_selection_control', controls)

    def set_force_scene_launch_buttons(self, buttons):
        self._set_scene_controls(b'force_launch_button', buttons)
    ...
    @listens_group(b'playing_position')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Akai_Force_MPC/session.pyc
