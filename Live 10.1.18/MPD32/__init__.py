...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MPD32\__init__.py
...
def get_capabilities():
    return {CONTROLLER_ID_KEY: controller_id(vendor_id=2536, product_ids=[108], model_name=b'Akai MPD32'), 
       PORTS_KEY: [
                 ...
                 outport(props=[])]}
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/MPD32/__init__.pyc
