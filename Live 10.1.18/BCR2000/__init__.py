...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\BCR2000\__init__.py
...
def get_capabilities():
    return {CONTROLLER_ID_KEY: controller_id(vendor_id=5015, product_ids=[188], model_name=b'BCR2000'), 
       PORTS_KEY: [
                 inport(props=[NOTES_CC, SCRIPT]), outport(props=[SCRIPT])]}
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/BCR2000/__init__.pyc
