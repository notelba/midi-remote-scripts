...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\DrumGroupComponent.py
...
class ResettingScrollComponent(ScrollComponent):
    ...
    def _update_scroll_buttons(self):
        if self.can_scroll_up():
            self.scroll_up_button.color = b'Scrolling.Enabled'
            self.scroll_up_button.pressed_color = b'Scrolling.Pressed'
        else:
            self.scroll_up_button.color = b'Scrolling.Disabled'
            self.scroll_up_button.pressed_color = b'Scrolling.Disabled'
        if self.can_scroll_down():
            self.scroll_down_button.color = b'Scrolling.Enabled'
            self.scroll_down_button.pressed_color = b'Scrolling.Pressed'
        else:
            self.scroll_down_button.color = b'Scrolling.Disabled'
            self.scroll_down_button.pressed_color = b'Scrolling.Disabled'
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/DrumGroupComponent.pyc
