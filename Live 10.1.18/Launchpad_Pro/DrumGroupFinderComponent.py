...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\DrumGroupFinderComponent.py
...
class DrumGroupFinderComponent(ControlSurfaceComponent, Subject):
    ...
    @subject_slot_group(b'devices')
    def _on_devices_changed(self, chain):
        self.update()

    @subject_slot_group(b'chains')
    def _on_chains_changed(self, chain):
        self.update()

    @subject_slot(b'target_track')
...
def find_drum_group_device(track_or_chain):
    ...
    return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/DrumGroupFinderComponent.pyc
