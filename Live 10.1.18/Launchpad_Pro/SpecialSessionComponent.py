...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\SpecialSessionComponent.py
...
class SpecialClipSlotComponent(ClipSlotComponent):
    ...
    def _do_select_clip(self, clip_slot):
        ...
        if self._clip_slot is not None:
            ...
            if not self.application().view.is_view_visible(b'Detail/Clip'):
...
class SpecialSessionComponent(SessionComponent):
    ...
    delete_button = ButtonControl(color=b'DefaultButton.Off', pressed_color=b'DefaultButton.On')
    quantize_button = ButtonControl(color=b'DefaultButton.Off', pressed_color=b'DefaultButton.On')
    double_button = ButtonControl(color=b'DefaultButton.Off', pressed_color=b'DefaultButton.On')
    duplicate_button = ButtonControl(color=b'DefaultButton.Off', pressed_color=b'DefaultButton.On')
...
class SessionZoomingManagerComponent(ControlSurfaceComponent):
    session_zooming_button = ButtonControl(color=b'Session.Enabled')
    ...
    def session_zooming_button(self, button):
        ...
        """
        self._modes.selected_mode = b'prioritized_session_zooming_mode'
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/SpecialSessionComponent.pyc
