...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\SliderElement.py
...
class SliderElement(SliderElementBase):
    ...
    def update(self):
        if len(self.resource.owners) > 0:
            self._setup_fader()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/SliderElement.pyc
