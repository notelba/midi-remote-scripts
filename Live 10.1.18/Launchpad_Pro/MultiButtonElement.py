...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\MultiButtonElement.py
...
class MultiButtonElement(ConfigurableButtonElement):
    ...
    def __init__(self, slave_channels, is_momentary, msg_type, channel, identifier, skin=None, default_states=None, name=b'', color_slaves=False, *a, **k):
        super(MultiButtonElement, self).__init__(is_momentary, msg_type, channel, identifier, skin, default_states, *a, **k)
        self.name = name
        self._slave_buttons = [ SlaveButtonElement(self, is_momentary, msg_type, slave_channel, identifier, skin, (default_states if color_slaves else None), name=(name + b'_ch_' + str(slave_channel + 1)), *a, **k) for slave_channel in slave_channels
                              ]
        return
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/MultiButtonElement.pyc
