...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\Launchpad_Pro.py
...
class MidiMap(SpecialMidiMap):
    ...
    def __init__(self, *a, **k):
        ...
        left_button_names = ('Session_Record_Button', 'Double_Loop_Button', 'Duplicate_Button',
                             ...
                             'Shift_Button')
        default_states = {True: b'DefaultButton.On', False: b'DefaultButton.Off'}
        rec_states = {True: b'Recording.On', False: b'Recording.Off'}
        shift_states = {True: b'Misc.ShiftOn', False: b'Misc.Shift'}
        ...
        self.add_button(b'Record_Arm_Mode_Button', 0, 1, MIDI_CC_TYPE, default_states={True: b'Mode.RecordArm.On', False: b'Mode.RecordArm.Off'})
        self.add_button(b'Track_Select_Mode_Button', 0, 2, MIDI_CC_TYPE, default_states={True: b'Mode.TrackSelect.On', False: b'Mode.TrackSelect.Off'})
        self.add_button(b'Mute_Mode_Button', 0, 3, MIDI_CC_TYPE, default_states={True: b'Mode.Mute.On', False: b'Mode.Mute.Off'})
        self.add_button(b'Solo_Mode_Button', 0, 4, MIDI_CC_TYPE, default_states={True: b'Mode.Solo.On', False: b'Mode.Solo.Off'})
        self.add_button(b'Volume_Mode_Button', 0, 5, MIDI_CC_TYPE, default_states={True: b'Mode.Volume.On', False: b'Mode.Volume.Off'})
        self.add_button(b'Pan_Mode_Button', 0, 6, MIDI_CC_TYPE, default_states={True: b'Mode.Pan.On', False: b'Mode.Pan.Off'})
        self.add_button(b'Sends_Mode_Button', 0, 7, MIDI_CC_TYPE, default_states={True: b'Mode.Sends.On', False: b'Mode.Sends.Off'})
        self.add_button(b'Stop_Clip_Mode_Button', 0, 8, MIDI_CC_TYPE, default_states={True: b'Mode.StopClip.On', False: b'Mode.StopClip.Off'})
        ...
        self.add_modifier_button(b'Session_Mode_Button', 0, 95, MIDI_CC_TYPE, default_states={True: b'Mode.Session.On', False: b'Mode.Session.Off'}, element_factory=make_multi_button)
        self.add_button(b'Note_Mode_Button', 0, 96, MIDI_CC_TYPE, element_factory=make_multi_button)
        self.add_button(b'Device_Mode_Button', 0, 97, MIDI_CC_TYPE, default_states={True: b'Mode.Device.On', False: b'Mode.Device.Off'}, element_factory=make_multi_button)
        self.add_button(b'User_Mode_Button', 0, 98, MIDI_CC_TYPE, default_states={True: b'Mode.User.On', False: b'Mode.User.Off'}, element_factory=make_multi_button, color_slaves=True)
        self.add_matrix(b'Scene_Launch_Button_Matrix', make_button, 0, [[ identifier for identifier in xrange(89, 18, -10) ]], MIDI_CC_TYPE)
        self[b'Scene_Stop_Button_Matrix'] = self[b'Scene_Launch_Button_Matrix'].submatrix[
         :7, :]
...
class Launchpad_Pro(IdentifiableControlSurface, OptimizedControlSurface):
    ...
    def _create_user_mode(self):
        self._modes.add_mode(b'user_mode', [partial(self._layout_setup, consts.USER_LAYOUT_SYSEX_BYTE)])
    ...
    def _update_note_mode_button(self, focused_track_is_drum_track):
        ...
        if focused_track_is_drum_track:
            ...
            button.default_states = {True: b'Mode.Chromatic.On', 
               False: b'Mode.Chromatic.Off'}
        button.reset_state()
        self._modes.update()
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/Launchpad_Pro.pyc
