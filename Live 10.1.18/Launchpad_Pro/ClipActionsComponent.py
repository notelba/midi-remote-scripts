...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Launchpad_Pro\ClipActionsComponent.py
...
class ClipActionsComponent(ControlSurfaceComponent, Subject):
    ...
    @subject_slot(b'playing_slot_index')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Launchpad_Pro/ClipActionsComponent.pyc
