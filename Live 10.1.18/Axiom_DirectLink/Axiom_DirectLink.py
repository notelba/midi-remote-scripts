...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Axiom_DirectLink\Axiom_DirectLink.py
...
class Axiom_DirectLink(ControlSurface):
    ...
    def __init__(self, c_instance):
        ...
        with self.component_guard():
            ...
            self._suggested_input_port = b'DirectLink'
            self._suggested_output_port = b'DirectLink'
    ...
    def disconnect(self):
        self._display_data_source.set_display_string(b'  ')
    ...
    def _setup_device(self):
        ...
        for offset in range(8):
            ...
            self._encoders[(-1)].name = b'Device_Control_' + str(offset)
        ...
        prev_bank_button.name = b'Device_Bank_Down_Button'
        next_bank_button.name = b'Device_Bank_Up_Button'
        ...
        if self._mixer.is_enabled():
            ...
            if sender.mapped_parameter() != None:
                ...
                if track == master:
                    ...
                    display_string = str(chr(ord(b'A') + list(returns).index(track)))
                else:
                    assert False
                display_string += b' Vol'
            self._display_data_source.set_display_string(display_string)
            self._set_display_data_source(self._display_data_source)
            self._display_reset_delay = STANDARD_DISPLAY_DELAY
        return
    ...
    def _show_startup_message(self):
        self._display.display_message(b'LIVE')
    ...
    def _set_display_data_source(self, data_source):
        ...
        data_source.update()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Axiom_DirectLink/Axiom_DirectLink.pyc
