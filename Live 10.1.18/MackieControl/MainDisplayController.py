...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MackieControl\MainDisplayController.py
...
class MainDisplayController(MackieControlComponent):
    ...
    def __generate_6_char_string(self, display_string):
        ...
        assert len(ret) == 6
        return ret
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/MackieControl/MainDisplayController.pyc
