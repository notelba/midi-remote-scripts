...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\padKONTROL\__init__.py
...
def get_capabilities():
    return {CONTROLLER_ID_KEY: controller_id(vendor_id=2372, product_ids=[261], model_name=b'padKONTROL'), 
       PORTS_KEY: [
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/padKONTROL/__init__.pyc
