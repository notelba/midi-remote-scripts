...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MackieControl_Classic\MainDisplay.py
...
class MainDisplay(MackieControlComponent):
    ...
    def destroy(self):
        ...
        upper_message = (b'Ableton Live').center(NUM_CHARS_PER_DISPLAY_LINE)
        self.send_display_string(upper_message, 0, 0)
        lower_message = (b'Device is offline').center(NUM_CHARS_PER_DISPLAY_LINE)
    ...
    def on_update_display_timer(self):
        pass
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/MackieControl_Classic/MainDisplay.pyc
