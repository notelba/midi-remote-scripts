...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MackieControl_Classic\TimeDisplay.py
...
class TimeDisplay(MackieControlComponent):
    ...
    def clear_display(self):
        time_string = [ b' ' for i in range(10) ]
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/MackieControl_Classic/TimeDisplay.pyc
