...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\MackieControl_Classic\MackieControl.py
...
class MackieControl:
    ...
    def connect_script_instances(self, instanciated_scripts):
        ...
        try:
            ...
            print(b'failed to load the MackieControl XT script (might not be installed)')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/MackieControl_Classic/MackieControl.pyc
