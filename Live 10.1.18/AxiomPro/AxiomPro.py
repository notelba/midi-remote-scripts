...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\AxiomPro\AxiomPro.py
...
class AxiomPro(ControlSurface):
    ...
    def disconnect(self):
        ...
        self._send_midi(SYSEX_START + (17, 3, 0, 4, 65, 98, 108, 101, 116, 111, 110,
                                       ...
                                       100, 46, 247))
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/AxiomPro/AxiomPro.pyc
