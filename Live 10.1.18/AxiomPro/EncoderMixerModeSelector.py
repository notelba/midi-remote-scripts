...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\AxiomPro\EncoderMixerModeSelector.py
...
class EncoderMixerModeSelector(ModeSelectorComponent):
    ...
    def _mixer_assignments_changed(self):
        self.update()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/AxiomPro/EncoderMixerModeSelector.pyc
