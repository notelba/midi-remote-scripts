...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Oxygen_3rd_Gen\TransportViewModeSelector.py
...
class TransportViewModeSelector(ModeSelectorComponent):
    ...
    def _on_view_changed(self):
        if self.application().view.is_view_visible(b'Session'):
            ...
            self._mode_index = 0
        self.update()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Oxygen_3rd_Gen/TransportViewModeSelector.pyc
