...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Oxygen_3rd_Gen\SpecialMixerComponent.py
...
class SpecialMixerComponent(MixerComponent):
    ...
    def _prev_track_value(self, value):
        ...
        self._selected_tracks.append(self.song().view.selected_track)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Oxygen_3rd_Gen/SpecialMixerComponent.pyc
