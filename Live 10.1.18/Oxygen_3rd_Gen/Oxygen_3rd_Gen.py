...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Oxygen_3rd_Gen\Oxygen_3rd_Gen.py
...
class Oxygen_3rd_Gen(ControlSurface):
    ...
    def __init__(self, c_instance):
        ...
        with self.component_guard():
            is_momentary = True
            self._suggested_input_port = b'Oxygen'
            self._suggested_output_port = b'Oxygen'
    ...
    def _shift_value(self, value):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Oxygen_3rd_Gen/Oxygen_3rd_Gen.pyc
