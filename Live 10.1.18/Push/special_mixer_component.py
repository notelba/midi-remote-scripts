...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\special_mixer_component.py
...
class SpecialMixerComponent(components.MixerComponent):
    ...
    def __init__(self, *a, **k):
        ...
        self._selected_track_data_sources[0].set_display_string(b'Track Selection:')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/special_mixer_component.pyc
