...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\handshake_component.py
...
class HandshakeComponent(Component):
    ...
    def firmware_version(self):
        ...
        return get_version_number_from_string(b' %d %d %d %d' % version_bytes)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/handshake_component.pyc
