...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\firmware_handling.py
# Compiled at: 2020-07-14 15:33:45
from __future__ import absolute_import, print_function, unicode_literals
from os import path
VERSION_PREFIX = str(b'10F4000041444139204E69636F6C6C73')
NUM_VERSION_BYTES = 8
PRESET_FILE_NAME = b'Preset.syx'
...
def get_provided_firmware_version():
    ...
    try:
        ...
        with open(path.join(mod_path, PRESET_FILE_NAME), b'r') as (f):
    ...
    return result
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/firmware_handling.pyc
