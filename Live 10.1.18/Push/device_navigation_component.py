...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\device_navigation_component.py
...
class DeviceNavigationComponent(Component):
    ...
    @listens(b'press_option', in_front=True)
    ...
    def _update_exit_button(self):
        ...
        if self.is_enabled() and button:
            with disconnectable(self._make_exit_node()) as (node):
                button.set_light(b'DefaultButton.On' if node else b'DefaultButton.Disabled')
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/device_navigation_component.pyc
