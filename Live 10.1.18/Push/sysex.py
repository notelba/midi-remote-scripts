...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\sysex.py
...
CALIBRATION_SET = START + (87, 0, 20) + to_sysex_int(215, b'Preload Scale Factor') + to_sysex_int(1000, b'Recalibration Interval') + to_sysex_int(200, b'Stuck Pad Detection Threshold') + to_sysex_int(0, b'Stuck Pad NoteOff Threshold Adder') + to_sysex_int(200, b'Pad Ignore Time') + (247, )
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/sysex.pyc
