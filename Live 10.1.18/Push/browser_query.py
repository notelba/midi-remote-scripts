...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\browser_query.py
...
class SourceBrowserQuery(TagBrowserQuery):
    ...
    def query(self, browser):
        ...
        return map(lambda (k, g): VirtualBrowserItem(name=k if k is not None else b'', children_query=const(g)), sorted(groups.items(), key=first))
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/browser_query.pyc
