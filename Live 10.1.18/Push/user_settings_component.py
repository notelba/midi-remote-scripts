...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push\user_settings_component.py
...
class UserSettingsComponent(Component):
    ...
    @listens_group(b'normalized_value')
...
class UserComponent(UserComponentBase):
    ...
    settings_layer = forward_property(b'_settings')(b'layer')
    settings = forward_property(b'_settings')(b'settings')
    ...
    def post_trigger_action(self, button):
        self.toggle_mode()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/Push/user_settings_component.pyc
