...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\parameter_slot_description.py
# Compiled at: 2020-05-05 13:23:28
from __future__ import absolute_import, print_function, unicode_literals
from ..base import find_if, listenable_property, listens_group, liveobj_valid, EventObject
RESULTING_NAME_KEY = b'ResultingName'
DISPLAY_NAME_KEY = b'DisplayName'
CONDITION_NAME_KEY = b'ConditionName'
CONDITIONS_LIST_NAME_KEY = b'ConditionsListName'
PREDICATE_KEY = b'Predicate'
OPERAND_NAME_KEY = b'Operand'
AND = b'and'
OR = b'or'
...
class ParameterSlotDescription(EventObject):
    ...
    def __init__(self, *a, **k):
        ...
        self._default_parameter_name = b''
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/parameter_slot_description.pyc
