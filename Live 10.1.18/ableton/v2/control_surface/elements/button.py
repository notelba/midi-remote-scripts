...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\elements\button.py
...
class ButtonElement(InputControlElement, ButtonElementMixin):
    ...
    def is_momentary(self):
        """ returns true if the button sends a message on being released """
    ...
    def _disconnect_color_listener(self):
        ...
        return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/elements/button.pyc
