...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\elements\encoder.py
...
class EncoderElement(InputControlElement):
    ...
    __events__ = (
     Event(name=b'normalized_value', signal=InputSignal),)
...
class FineGrainWithModifierEncoderElement(WrapperElement):
    ...
    def set_sensitivities(self, default, modified):
        ...
        self._enforce_control_invariant()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/elements/encoder.pyc
