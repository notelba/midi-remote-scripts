...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\input_control_element.py
...
class InputControlElement(NotifyingControlElement):
    ...
    __events__ = (
     Event(name=b'value', signal=InputSignal, override=True),)
    ...
    def _last_sent_value(self):
        ...
        return -1
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/input_control_element.pyc
