...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\component.py
...
class Component(ControlManager):
    ...
    def __init__(self, name=b'', parent=None, register_component=None, song=None, layer=None, is_enabled=True, *a, **k):
    ...
    def _grab_all_layers(self):
        for layer in self._get_layer_iterable():
            ...
            assert grabbed, b'Only one component can use a layer at a time'
    ...
    def _get_layer_iterable(self):
        if self._layer is None:
            ...
            if is_iterable(self._layer):
                return self._layer
            return (self._layer,)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/component.pyc
