...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\control\control_list.py
...
class MatrixControl(ControlList):
    ...
    class State(ControlList.State):
        ...
        def _make_control(self, index):
            ...
            if hasattr(control._get_state(self._manager), b'coordinate'):
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/control/control_list.pyc
