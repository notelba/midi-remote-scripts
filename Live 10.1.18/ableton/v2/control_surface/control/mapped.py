...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\control\mapped.py
...
def is_zoom_parameter(parameter):
    ...
    """
    return hasattr(parameter, b'zoom')
...
class MappedSensitivitySettingControl(MappedControl):
    ...
    class State(MappedControl.State):
        ...
        def _update_control_sensitivity(self):
            if hasattr(self._control_element, b'set_sensitivities'):
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/control/mapped.pyc
