...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\control\encoder.py
...
class EncoderControl(InputControl):
    ...
    class State(InputControl.State, Connectable):
        ...
        def __init__(self, control=None, manager=None, touch_event_delay=0, *a, **k):
            ...
            self._touch_value_slot = self.register_slot(None, self._on_touch_value, b'value')
            return
        ...
        def _get_touch_element(self, control_element):
            return getattr(control_element, b'touch_element', None)
        ...
        def _notify_encoder_value(self, value, *a, **k):
            ...
            self._call_listener(b'value', normalized_value)
...
class ValueStepper(object):
    ...
    def reset(self):
        """ Resets the Value Stepper's state, as if it had never been advanced. """
        self._step = 0.0
...
class StepEncoderControl(EncoderControl):
    ...
    class State(EncoderControl.State):
        ...
        def _notify_encoder_value(self, value, *a, **k):
            ...
            if steps != 0:
                self._call_listener(b'value', steps)
        ...
        def _on_stepped(self, steps):
            if self._list_values_getter is not None:
                ...
                try:
                    ...
                    logger.warning(b'Encoder was turned, but current value is not in list!')
                    current_index = 0
...
class SendValueEncoderControl(EncoderControl):
    ...
    class State(SendValueMixin, EncoderControl.State):
        pass
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/control/encoder.pyc
