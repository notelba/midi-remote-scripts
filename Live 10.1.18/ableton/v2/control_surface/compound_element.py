...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\compound_element.py
...
class CompoundElement(NotifyingControlElement, ControlElementClient):
    ...
    def __getitem__(self, index_or_slice):
        if isinstance(index_or_slice, slice):
            ...
            return
            return
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/compound_element.pyc
