...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\default_bank_definitions.py
...
BANK_DEFINITIONS = {b'AudioEffectGroupDevice': RACK_BANKS, 
   ...
   b'ChannelEq': IndexedDict((
                (
                 ...
                 {BANK_PARAMETERS_KEY: (
                                        b'Highpass On',
                                        use(b'Low Gain').with_name(b'Low'),
                                        use(b'Mid Gain').with_name(b'Mid'),
                                        b'Mid Freq',
   ...
   b'MidiPitcher': IndexedDict((
                  (
                   BANK_MAIN_KEY, {BANK_PARAMETERS_KEY: (b'Pitch', b'Range', b'Lowest', b'', b'', b'', b'', b'')}),)), 
   ...
   b'Amp': IndexedDict((
          (
           ...
           {BANK_PARAMETERS_KEY: (
                                  ...
                                  b'Dry/Wet')}),
          (
           b'Dual/Mono', {BANK_PARAMETERS_KEY: (b'Dual Mono', b'', b'', b'', b'', b'', b'', b'')}))), 
   ...
   b'Delay': IndexedDict((
            ...
            (
             b'Time',
             {BANK_PARAMETERS_KEY: (
                                    use(b'Delay Mode').with_name(b'DlayMd'),
                                    b'Link',
                                    b'Ping Pong',
                                    b'L Offset',
                                    b'R Offset',
   ...
   b'Tube': IndexedDict((
           (
            ...
            {BANK_PARAMETERS_KEY: (
                                   ...
                                   b'Dry/Wet')}),
           (
            b'Output', {BANK_PARAMETERS_KEY: (b'', b'', b'', b'', b'', b'', b'Output', b'Dry/Wet')}))), 
   b'Echo': IndexedDict((
           (
            BANK_MAIN_KEY,
            {BANK_PARAMETERS_KEY: (
   ...
   b'FilterEQ3': IndexedDict((
                (
                 ...
                 {BANK_PARAMETERS_KEY: (
                                        ...
                                        b'FreqHi')}),
                (
                 b'Slope', {BANK_PARAMETERS_KEY: (b'Slope', b'', b'', b'', b'', b'', b'', b'')}))), 
   ...
   b'Vocoder': IndexedDict((
              ...
              (
               ...
               {BANK_PARAMETERS_KEY: (
                                      b'Noise Rate',
                                      b'Noise Crackle',
                                      b'Upper Pitch Detection',
                                      b'Lower Pitch Detection',
                                      b'Oscillator Pitch',
...
PARAMETERS_BLACKLIST_FOR_CPP_SANITY_CHECK = {b'OriginalSimpler': (
                      ...
                      b'Envelope',
                      b'Grain Size Tones',
                      b'Grain Size Texture',
                      b'Flux',
                      b'Formants',
                      b'Envelope Complex Pro',
                      b'Gain'), 
   b'InstrumentVector': (
                       b'Osc 1 Effect Type',
                       b'Osc 2 Effect Type',
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/default_bank_definitions.pyc
