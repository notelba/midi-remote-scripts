...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\drum_group.py
...
class DrumGroupComponent(PlayableComponent, SlideComponent, Slideable):
    ...
    def delete_pitch(self, drum_pad):
        ...
        raise NotImplementedError
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/components/drum_group.pyc
