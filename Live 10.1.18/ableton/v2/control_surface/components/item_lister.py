...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\item_lister.py
...
class ItemListerComponent(ItemListerComponentBase):
    ...
    def _on_select_button_released_immediately(self, button):
        pass
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/components/item_lister.pyc
