...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\auto_arm.py
...
class AutoArmComponent(Component):
    ...
    def _on_frozen_state_changed(self, track):
        self._update_implicit_arm_task.restart()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/components/auto_arm.pyc
