...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\transport.py
...
class TransportComponent(Component):
    ...
    tap_tempo_button = ButtonControl(color=b'DefaultButton.On', pressed_color=b'DefaultButton.Off')
    ...
    def __init__(self, *a, **k):
        ...
        song = self.song
        self._loop_toggle = ToggleComponent(b'loop', song, parent=self)
        self._punch_in_toggle = ToggleComponent(b'punch_in', song, is_momentary=True, parent=self)
        self._punch_out_toggle = ToggleComponent(b'punch_out', song, is_momentary=True, parent=self)
        self._record_toggle = ToggleComponent(b'record_mode', song, parent=self)
        self._nudge_down_toggle = ToggleComponent(b'nudge_down', song, is_momentary=True, parent=self)
        self._nudge_up_toggle = ToggleComponent(b'nudge_up', song, is_momentary=True, parent=self)
        self._metronome_toggle = ToggleComponent(b'metronome', song, parent=self)
        self._arrangement_overdub_toggle = ToggleComponent(b'arrangement_overdub', song, parent=self)
        self._overdub_toggle = ToggleComponent(b'overdub', song, parent=self)
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/components/transport.pyc
