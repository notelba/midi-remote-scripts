...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\components\view_control.py
...
class ViewControlComponent(Component):
    ...
    def __init__(self, *a, **k):
        ...
        song = self.song
        view = song.view
        self.register_slot(song, self._scroll_tracks.update, b'visible_tracks')
        self.register_slot(song, self._scroll_tracks.update, b'return_tracks')
        self.register_slot(song, self._scroll_scenes.update, b'scenes')
        self.register_slot(song, self._scroll_scene_list.update, b'scenes')
        self.register_slot(view, self._scroll_tracks.update, b'selected_track')
        self.register_slot(view, self._scroll_scenes.update, b'selected_scene')
        self.register_slot(view, self._scroll_scene_list.update, b'selected_scene')
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/components/view_control.pyc
