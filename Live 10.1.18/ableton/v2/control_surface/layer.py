...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\control_surface\layer.py
...
class LayerClient(ControlElementClient):
    ...
    def set_control_element(self, control_element, grabbed):
        ...
        if not control_element in layer._element_to_names:
            raise AssertionError(b'Control not in layer: %s' % (
             control_element,))
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/control_surface/layer.pyc
