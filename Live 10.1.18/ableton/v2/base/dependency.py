...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\ableton\v2\base\dependency.py
...
def get_dependency_for(name, default=None):
    ...
    if accessor is not None:
        ...
        raise DependencyError(b'Required dependency %s not provided' % name)
        return
...
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/ableton/v2/base/dependency.pyc
