...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Axiom\Encoders.py
...
class Encoders:
    ...
    def __show_bank_select(self, bank_name):
        if self.__selected_device:
            self.__parent.show_message(str(self.__selected_device.name + b' Bank: ' + bank_name))
    ...
    def __on_device_parameters_changed(self):
        self.__parent.request_rebuild_midi_map()
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Axiom/Encoders.pyc
