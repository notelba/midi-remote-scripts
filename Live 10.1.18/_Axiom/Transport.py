...
# Embedded file name: c:\Jenkins\live\output\Live\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Axiom\Transport.py
...
class Transport:
    ...
    def receive_midi_cc(self, cc_no, cc_value):
        ...
        elif self.__parent.application().view.is_view_visible(b'Session'):
            if cc_value > 0:
    ...
    def refresh_state(self):
        ...
        if self.__rwd_held:
            ...
            if self.__delay_counter % 5 == 0:
                self.__parent.song().jump_by(-1 * self.__parent.song().signature_denominator)
# okay decompiling /home/deniz/data/projects/midiremote/Live 10.1.18/_Axiom/Transport.pyc
